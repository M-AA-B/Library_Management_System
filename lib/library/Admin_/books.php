...
<div id="main">
    ...
    <div class="srch">
        ...
        <form class="navbar-form" method="post" name="form1">
            ...
            <button style="background-color: #891635;" type="submit" name="submit1" class="btn btn-default">Delete
            </button>
        </form>
    </div>
    ...
    if(isset($_POST['submit']))
    {
        ...
        else
        {
            ...
            echo "<th>"; echo "Picture";  echo "</th>"; // New column for picture
            echo "</tr>";
            ...
            while($row=mysqli_fetch_assoc($q))
            {
                ...
                echo "<td>"; echo "<img src='book_img/".$row['image_path']."' width='100' height='100'>"; echo "</td>";
                echo "</tr>";
            }
            echo "</table>";
        }
    ...
    else
    {
        ...
        while($row=mysqli_fetch_assoc($res))
        {
            ...
            echo "<td>"; echo $row['department']; echo "</td>";
            echo "<td>";
            echo "<img src='book_img/".$row['image_path']."' width='100' height='100'>";
            echo "</td>";
