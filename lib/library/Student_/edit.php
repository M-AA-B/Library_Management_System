...
if(isset($_POST['submit']))
{
    ...
    $sql1= "UPDATE student SET pic='$pic', first='$first', last='$last', username='$username', password='$password', roll='$roll', email='$email', contact='$contact' WHERE username='".$_SESSION['login_user']."';";
