...
<div id="mySidenav" class="sidenav">
    ...
    <div class="h"> <a href="books.php">Book Request</a></div>
...
<div id="main">
    ...
    <div class="srch">
        <form class="navbar-form" method="post" name="form2">
            ...
            <button style="background-color: #891635;" type="submit" name="submit1" class="btn btn-default">Request
            </button>
        </form>
    </div>
    ...
    if(isset($_POST['submit'])) {
        ...
        if($result->num_rows === 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td>"; echo "<img src='../Admin_/book_img/".$row['image_path']."' width='100' height='100'>"; echo "</td>";
                echo "</tr>";
            }
            echo "</table>";
        }
        ...
        while($row = mysqli_fetch_assoc($res)) {
            ...
            echo "<td>"; echo $row['department']; echo "</td>";
            echo "<td>";
            echo "<img src='../Admin_/book_img/".$row['image_path']."' width='100' height='100'>";
            echo "</td>";
